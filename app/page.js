  ...
  return (<>
    <main>
      <div className="h-[800px] pt-[143px] bg-[url('../public/main1.jpg')] bg-cover">
        <div className="grid grid-cols-1 gap-[15vw] min-[1350px]:grid-cols-2 mt-[143px] mx-auto max-w-[1300px] px-4 max-[1350px]:justify-items-center">
          <div className="flex flex-col justify-between h-fit max-sm:gap-y-[25px] w-[95vw] min-[650px]:min-w-[600px] min-[650px]:max-w-[60%] sm:h-[372px] ml-3">
