  ...
  return (<>
    <main>
      <div className="h-[800px] pt-[143px] bg-[url('../public/main1.jpg')] bg-cover">
        <div className="flex justify-between max-[1300px]:justify-center max-[1300px]:text-center h-[576px] min-[1300px]:mx-[100px] min-[1700px]:mx-base">
          <div className="flex flex-col justify-between min-w-[600px] max-w-[60%] h-[372px] my-auto">
            ...
            <div className="block relative w-[600px] max-[1300px]:mx-auto">
          ...
          <div className="relative max-w-[455px] block max-[1300px]:hidden">
